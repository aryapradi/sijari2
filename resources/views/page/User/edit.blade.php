    ...
    <form action="/update_user/{{ $user->id }}" method="POST">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <div class="input-group-text">
                        <input type="checkbox" id="show_old_password"> Tampilkan
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <div class="input-group-text">
                        <input type="checkbox" id="show_password"> Tampilkan
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
            <a class="btn btn-secondary" href="/DataUser">Cancel</a>
...
<script>
    ...
    showOldPasswordCheckbox.addEventListener('change', function() {
        oldPasswordInput.type = showOldPasswordCheckbox.checked ? 'text' : 'password';
    });
